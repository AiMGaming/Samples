...
THREE.PDBLoader.prototype.load = function ( url, callback ) {
	...
	this.loadLocalPDB( this, url, callback );

};

//Read model from local file system.
THREE.PDBLoader.prototype.loadLocalPDB = function ( context, url, callback, callbackProgress ) 
{
    var txt = app.ReadFile( url );
	var json = context.parsePDB( txt );
	context.createModel( json, callback );

	context.onLoadComplete();
}

//Read model from internet.
